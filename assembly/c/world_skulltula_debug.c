...
/**
 * Helper function called to initialize structure after scene init.
 **/
...
/**
 * Helper function called to check whether or not the World Skulltula debug feature is enabled.
 **/
